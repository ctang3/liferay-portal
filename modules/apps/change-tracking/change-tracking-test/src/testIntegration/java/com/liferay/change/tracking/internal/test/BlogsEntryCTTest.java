...
public class BlogsEntryCTTest {
	...
	@Test
	public void testPublishCTCollectionWithBlogsEntryAdded() throws Exception {
	...
	@Test
	public void testPublishCTCollectionWithTitleAndContentUpdated()
		...
		Assert.assertNotNull(productionBlogsEntry);

		Assert.assertEquals(
			blogsEntry.getTitle(), productionBlogsEntry.getTitle());
		Assert.assertEquals(
			blogsEntry.getContent(), productionBlogsEntry.getContent());
	}
