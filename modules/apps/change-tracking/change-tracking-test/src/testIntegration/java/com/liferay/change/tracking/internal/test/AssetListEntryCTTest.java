...
public class AssetListEntryCTTest {
	...
	@Test
	public void testPublishAddedAssetListEntry() throws Exception {
	...
	@Test
	public void testPublishDeletedAssetListEntry() throws Exception {
		ServiceContext serviceContext =
			ServiceContextTestUtil.getServiceContext(
				_group.getGroupId(), TestPropsValues.getUserId());
	...
	@Test
	public void testPublishModifiedAssetListEntry() throws Exception {
		AssetListEntry manualAssetListEntry =
			_assetListEntryLocalService.addAssetListEntry(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				_group.getGroupId(), RandomTestUtil.randomString(),
