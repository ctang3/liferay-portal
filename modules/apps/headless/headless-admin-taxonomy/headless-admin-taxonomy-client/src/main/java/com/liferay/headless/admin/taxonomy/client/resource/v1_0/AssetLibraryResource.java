...
public interface AssetLibraryResource {
	...
	public HttpInvoker.HttpResponse
			getTaxonomyVocabularyAssetLibrariesPageHttpResponse(
				Long taxonomyVocabularyId)
		throws Exception;

	public void postTaxonomyVocabularyAssetLibrariesPageExportBatch(
			Long taxonomyVocabularyId, String callbackURL, String contentType,
			String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postTaxonomyVocabularyAssetLibrariesPageExportBatchHttpResponse(
	...
	public static class AssetLibraryResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/{taxonomyVocabularyId}/asset-libraries");
		...
		public void postTaxonomyVocabularyAssetLibrariesPageExportBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postTaxonomyVocabularyAssetLibrariesPageExportBatchHttpResponse(
					taxonomyVocabularyId, callbackURL, contentType, fieldNames);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-taxonomy/v1.0/taxonomy-vocabularies/{taxonomyVocabularyId}/asset-libraries/export-batch");
