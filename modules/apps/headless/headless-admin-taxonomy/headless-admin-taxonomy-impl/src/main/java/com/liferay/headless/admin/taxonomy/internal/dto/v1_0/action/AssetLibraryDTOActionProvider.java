...
import com.liferay.headless.admin.taxonomy.internal.dto.v1_0.action.metadata.AssetLibraryDTOActionMetadataProvider;
...
@Component(
	property = {
		"dto.class.name=com.liferay.headless.admin.taxonomy.dto.v1_0.AssetLibrary"
	},
	service = DTOActionProvider.class
)
@Generated("")
public class AssetLibraryDTOActionProvider implements DTOActionProvider {

	@Override
	public Map<String, ActionInfo> getActionInfos() throws Exception {
		Map<String, ActionInfo> actionInfos = new HashMap<>();

		AssetLibraryDTOActionMetadataProvider
			assetLibraryDTOActionMetadataProvider =
				new AssetLibraryDTOActionMetadataProvider();

		for (String actionName :
				assetLibraryDTOActionMetadataProvider.getActionNames()) {

			actionInfos.put(
				actionName,
				assetLibraryDTOActionMetadataProvider.getActionInfo(
					actionName));
		}
	...
	public Map<String, Map<String, String>> getActions(
		...
		for (String actionName :
			...
			ActionInfo actionInfo =
				assetLibraryDTOActionMetadataProvider.getActionInfo(actionName);
			...
			actions.put(
				...
				ActionUtil.addAction(
					...
					assetLibraryDTOActionMetadataProvider.getPermissionName(),
					groupId,
