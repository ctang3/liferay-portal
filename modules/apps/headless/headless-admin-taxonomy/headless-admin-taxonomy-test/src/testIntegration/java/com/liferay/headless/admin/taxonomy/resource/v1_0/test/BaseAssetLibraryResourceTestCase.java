...
import com.liferay.headless.admin.taxonomy.client.resource.v1_0.AssetLibraryResource;
...
public abstract class BaseAssetLibraryResourceTestCase {
	...
	@Test
	public void testGetTaxonomyVocabularyAssetLibrariesPage() throws Exception {
		Long taxonomyVocabularyId =
			testGetTaxonomyVocabularyAssetLibrariesPage_getTaxonomyVocabularyId();
		Long irrelevantTaxonomyVocabularyId =
			testGetTaxonomyVocabularyAssetLibrariesPage_getIrrelevantTaxonomyVocabularyId();
		...
		if (irrelevantTaxonomyVocabularyId != null) {
			AssetLibrary irrelevantAssetLibrary =
				testGetTaxonomyVocabularyAssetLibrariesPage_addAssetLibrary(
					irrelevantTaxonomyVocabularyId,
					randomIrrelevantAssetLibrary());

			page = assetLibraryResource.getTaxonomyVocabularyAssetLibrariesPage(
				irrelevantTaxonomyVocabularyId);

			Assert.assertEquals(totalCount + 1, page.getTotalCount());

			assertContains(
				irrelevantAssetLibrary, (List<AssetLibrary>)page.getItems());
			assertValid(
				page,
				testGetTaxonomyVocabularyAssetLibrariesPage_getExpectedActions(
					irrelevantTaxonomyVocabularyId));
		}

		AssetLibrary assetLibrary1 =
			testGetTaxonomyVocabularyAssetLibrariesPage_addAssetLibrary(
				taxonomyVocabularyId, randomAssetLibrary());
	...
	protected AssetLibrary
			testGetTaxonomyVocabularyAssetLibrariesPage_addAssetLibrary(
				Long taxonomyVocabularyId, AssetLibrary assetLibrary)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.admin.taxonomy.dto.v1_0.AssetLibrary.
						class)) {
	...
	@Inject
	private
		com.liferay.headless.admin.taxonomy.resource.v1_0.AssetLibraryResource
